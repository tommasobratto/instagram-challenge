...
feature 'instagram posts' do 
  ...
  context 'viewing posts' do 
    let!(:hhgoa) {Post.create(title: "Holy Hand Grenade of Antioch", description:'A Reading from the Book of Armaments, Chapter 4, Verses 16 to 20: 
Then did he raise on high the Holy Hand Grenade of Antioch, saying, "Bless this, O Lord, that with it thou mayst blow thine enemies to tiny bits, in thy mercy." And the people did rejoice and did feast upon the lambs and toads and tree-sloths and fruit-bats and orangutans and breakfast cereals ... Now did the Lord say, "First thou pullest the Holy Pin. Then thou must count to three. Three shall be the number of the counting and the number of the counting shall be three. Four shalt thou not count, neither shalt thou count two, excepting that thou then proceedeth to three. Five is right out. Once the number three, being the number of the counting, be reached, then lobbest thou the Holy Hand Grenade in the direction of thine foe, who, being naughty in my sight, shall snuff it."')}
  ...
  context 'editing posts' do 
    before do 
      Post.create(title: 'Holy Hand Grenade', description: 'A Reading from the Book of Armaments, Chapter 5')
    end

    scenario 'let a user edit a posts' do
      visit '/posts'
      click_link 'Edit Holy Hand Grenade'
      fill_in 'Title', with: 'Holy Hand Grenade of Antioch'
      fill_in 'Description', with: 'A Reading from the Book of Armaments, Chapter 4'
